...
class _MessagesListScreenState extends State<MessagesListScreen> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ChatSummary>>(
      stream: MarketplaceRepository.instance.watchMyChatsAsStudent(),
                  ...
                  ? Center(
                      child: _query.isEmpty
                          ? const EmptyStateView(
                              ...
                              subtitle:
                                  "Once you apply to a role or a founder reaches out, it'll show up here.",
                            )
                          : Text(
        ...
        onTap: () => Navigator.of(context).push(
          MaterialPageRoute(
            builder: (_) => ChatThreadScreen(
              startupUid: thread.peerUid,
              startupName: thread.peerName,
              startupGradientSeed: thread.peerGradientSeed,
            ),
          ),
        ),
        child: Container(
          ...
          child: Row(
            children: [
              Container(
                ...
                height: 44,
                decoration: BoxDecoration(
                  gradient: MarketplaceRepository.instance.gradientForSeed(
                    thread.peerGradientSeed,
                  ),
